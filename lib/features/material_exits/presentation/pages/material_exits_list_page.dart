...
import 'material_exit_detail_page.dart';
...
class MaterialExitsListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Salida de material"),
      ),
        ...
        data: (exits) => exits.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return MaterialExitCard(
                    exit: exit,
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => MaterialExitDetailPage(exit: exit),
                      ),
                    ),
                  );
                },
  ...
  Widget _buildEmptyState(BuildContext context) => Center(
        child: Column(
          ...
          children: [
            ...
            const Text("No hay salidas registradas", style: TextStyle(fontSize: 16)),
